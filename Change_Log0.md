...
/home/flyingeagle/rtl8188gu-rao/core/rtw_mlme_ext.c:1350:2: note: here
 1350 |  case WIFI_ASSOCREQ:
  ...
  CC [M]  /home/flyingeagle/rtl8188gu-rao/core/rtw_chplan.o
...
EXTRA_CFLAGS += -DCONFIG_RTL8188GU

_HAL_INTFS_FILES += hal/HalPwrSeqCmd.o \
					hal/$(RTL871X)/Hal8188GUPwrSeq.o\
					hal/$(RTL871X)/$(RTL871X)_sreset.o
...
ifeq ($(CONFIG_USB_HCI), y)
_HAL_INTFS_FILES +=hal/efuse/$(RTL871X)/HalEfuseMask8188GU_USB.o
endif

ifeq ($(CONFIG_SDIO_HCI), y)
_HAL_INTFS_FILES +=hal/efuse/$(RTL871X)/HalEfuseMask8188GU_SDIO.o
endif
...
obj-$(CONFIG_RTL8188GUU) := $(MODULE_NAME).o

else

export CONFIG_RTL8188GUU = m
